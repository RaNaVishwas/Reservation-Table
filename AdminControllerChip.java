...
public class AdminControllerChip {private Connection connection = ConnectionFactory.getMYSQLConnection();
private OperationChip operation = new OperationChip(connection);
