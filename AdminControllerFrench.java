...
public class AdminControllerFrench {private Connection connection = ConnectionFactory.getMYSQLConnection();
private OperationFrench operation = new OperationFrench(connection);
...
private void getAllImageViewsForButtons() {
    restaurantIMV = new ImageView(new Image(getClass().getResourceAsStream("Graphics/French.png")));
