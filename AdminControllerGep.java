...
public class AdminControllerGeo{private Connection connection = ConnectionFactory.getMYSQLConnection();
private OperationGeo operation = new OperationGeo(connection);
